...
import logo from "../assets/manipalLogoRec.png"

function AdminNav() {
  return (
    <nav>
    <Toaster/>
    <div className="h-20 bg-white w-full flex justify-center">
        <div className="flex items-center justify-between w-full px-4 md:w-1/2">
            <a href="/admin" className="p-1 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="#F37123">
       ...
       <img src={logo} alt="" className='h-10' />
        ...
        </span>            <a href="/login" className="font-semibold p-2 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="#F37123">
